...
<body>
    ...
    <div class="room-selection">
        ...
        <div class="rooms">
            ...
            <div class="room">
                ...
                <button type="button" class="book-room" onclick="openPaymentModal(event)">Book</button>
                <!-- Hidden Form for Booking -->
                <form action="insert_book_room.php" method="POST" class="booking-form" id="bookingForm1">
            ...
            <div class="room">
                ...
                <button type="button" class="book-room" onclick="openPaymentModal(event)">Book</button>
                <form action="insert_book_room.php" method="POST" class="booking-form" id="bookingForm2">
            ...
            <div class="room">
                ...
                <button type="button" class="book-room" onclick="openPaymentModal(event)">Book</button>
                <form action="insert_book_room.php" method="POST" class="booking-form" id="bookingForm3">
            ...
            <div class="room">
                ...
                <button type="button" class="book-room" onclick="openPaymentModal(event)">Book</button>
                <form action="insert_book_room.php" method="POST" class="booking-form" id="bookingForm4">
            ...
            <div class="room">
                ...
                <button type="button" class="book-room" onclick="openPaymentModal(event)">Book</button>
                <form action="insert_book_room.php" method="POST" class="booking-form" id="bookingForm5">
        ...
        <div class="modal-content">
            ...
            <div id="paymentForms" style="margin-top: 20px; display: none;">
                ...
                <div id="bkashForm" class="payment-form" style="display: none;">
                    ...
                    <!-- <input type="number" id="bkash-amount" class="bkash-amount" name="bkash-amount" readonly> -->
                    <span id="bkash-amount" class="bkash-amount">0.00</span>
                </div>
                ...
                <div id="paypalForm" class="payment-form" style="display: none;">
                    ...
                    <!-- <input type="number" id="paypal-amount" name="paypal-amount" readonly> -->
                    <span id="paypal-amount" class="payment-amount">0.00</span>
                </div>
                ...
                <div id="visaForm" class="payment-form" style="display: none;">
                    ...
                    <!-- <input type="number" id="visa-amount" name="visa-amount" readonly> -->
                    <span id="visa-amount" class="payment-amount">0.00</span>
                </div>
            </div>
    ...
    <div id="otpModal" class="modal" style="display: none;">
        <div class="modal-content">
            ...
            <h2>Enter OTP</h2>
            <p>A One-Time Password has been sent to your registered email/phone.</p>
            <form id="otpForm">
                <input type="text" name="otp" id="otpInput" maxlength="6" placeholder="Enter OTP" required>
    ...
    <!-- Trigger Button -->
    <button onclick="openOtpModal()">Open OTP Modal</button>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            rooms.forEach((room) => {
                ...
                const calculateDuration = () => {
                    ...
                    // Update the Bkash amount span with the total price
                    const bkashAmountSpan = document.getElementById("bkash-amount");
                    document.getElementById("paypal-amount").textContent = totalPrice.toFixed(2); // adding for paypal amount (Fahad)
                    document.getElementById("visa-amount").textContent = totalPrice.toFixed(2); // adding for visa amount (Fahad)
                    bkashAmountSpan.textContent = totalPrice.toFixed(2); // Format the total price to 2 decimal places
                ...
                durationInput.addEventListener("input", calculateDuration);
            });
